#!/usr/bin/env python3
"""zh_worksheet.py — lay out the evidence for every locked term, verse by verse,
so each Chinese rendering can be chosen with its context in view
(zh-keyword-standardize Step 3).
...
from zh_common import blocks, load_json, forms, clean_bo
...
def main(argv=None):
    ...
    if a.template:
        if a.template.exists():
            ...
            t = {"_meta": {"lang": a.lang, "grade": a.grade, "script": "Traditional", "lang_tag": "zh-Hant",
                           "title": "Chinese word list", "choices": "", "decided_by": "", "sources_note": "",
